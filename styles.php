...
.desform {
  ...
  div.form-container select { margin-top:5px; }
	...
	div.form-container input:focus, /*CSS2 SUCKS -.- */
...
.postPoll .title {
	background: url(/images/big2v1.png) 0 -88px no-repeat;
    margin-bottom: 15px;
    padding-top: 2px;
    padding-left: 20px;
    height: 16px;
...
.postPoll #vote label:hover {
	color: #36F;
}

.postPoll label.myVote {
	color: #00C;
    font-size: 13px;
}
...
.systemicons.rango11 {background-position: 0 -682px;} /* Super Posteador */
.systemicons.rango6 {background-position: 0 -705px;} /* Moderador */
.systemicons.rango13 {background-position: 0 -705px;} /* Moderador JR */  
.systemicons.rango9 {background-position: 0 -705px;} /* Jefe moderador */
...
.systemicons.right {background-position: 0 -18px;}
.systemicons.sexoM {background-position: -2px -132px}
.systemicons.sexoF {background-position: 0 -153px}
.systemicons.messages {background-position:0 -221px;}
...
.systemicons.online { background-position: 0 -791px; }
.systemicons.offline { background-position: 0 -813px; }
.systemicons.ausente { background-position: 0 -1481px; }
.systemicons.ocupado { background-position: 0 -1464px; }
.systemicons.borradores { background-position: 0 -1503px; }
.systemicons.follow { background-position: 0 -1364px; }
.systemicons.unfollow { background-position: 0 -1382px; }
.systemicons.dcomentarios { background-position: left -834px; margin-left: 3px; margin-top: -2px; }
...
.comment-info .answerOptions #votos_total {
	margin-right: 5px;
}
...
.comentario-post:hover .avatar-32{
    ...
    .avatar-box li.denunciarc a span { background-position: 0 -147px; }
    ...
    .avatar-box li.denunciarc a:hover span { background-position: 0 -130px; }
	...
	.post-estadisticas .icons.monitor {
        ...
        .comunidades #izquierda .btn_g span.follow {
...
.especial2 .comment-box { -moz-box-shadow: 0 0px 10px #FFCBCB;-webkit-box-shadow: 0 0px 10px #FFCBCB;box-shadow: 0 0px 10px #FFCBCB;border: 1px solid #F00; }
.especial3 .comment-box { -moz-box-shadow: 0 0px 10px #F4F400;-webkit-box-shadow: 0 0px 10px #F4F400;box-shadow: 0 0px 10px #F4F400;border: 1px solid #F4F400; }
...
.icon-medallas, .listado-content .medalla, .com-thread .medalla {
	background-image: url('/images/sprite-notification.png?1.0');
	display:block;
	height:16px;
	width:16px;
}
...
.super-posteador .w-stats ul li { color:#01a021;	background: #e6faea; }
.super-posteador .w-stats ul li a { color: #01a021 }
.super-posteador .w-stats ul li span {	color: #01a021; }
...
.jefe-moderador .w-stats ul li { color:#333;	background: #EEE; text-shadow: 0 1px 0 #FFF; }
.jefe-moderador .w-stats ul li a { color: #333 }
.jefe-moderador .w-stats ul li span {	color: #333; }

.administrador .w-stats ul li { color:#333;	background: #EEE; text-shadow: 0 1px 0 #FFF; }
.administrador .w-stats ul li a { color: #333 }
.administrador .w-stats ul li span {	color: #333; }
...
.tabbed-d fieldset {clear: both;}
.tabbed-d legend {padding: 0 0 1.286em; font-size: 1.167em; font-weight: 700;}
.tabbed-d fieldset fieldset legend {padding: 0 0 1.5em; font-size: 1em;}
* html .tabbed-d legend {margin-left: -7px;} /* ie6 */
*+html .tabbed-d legend {margin-left: -7px;} /* ie7 */

.tabbed-d form .field, .tabbed-d form .buttons {clear: both; margin: 0 0 1.5em; float:left; width:100%}
.tabbed-d form .field label {display: block;}
.tabbed-d form ul.fields {margin: 0 0 1.5em; padding: 0;}
.tabbed-d form ul.fields li {list-style-type: none; margin: 0;}\

.tabbed-d form ul.inline li, .tabbed-d  form ul.inline label {display: inline;}
.tabbed-d form ul.inline li {padding: 0 .75em 0 0;}

.tabbed-d input.radio, .tabbed-d input.checkbox {vertical-align: top; margin: 0 5px 0 0}
.tabbed-d label,.tabbed-d  button, .tabbed-d input.submit, .tabbed-d input.image {cursor: pointer;}
* html .tabbed-d  input.radio, * html .tabbed-d input.checkbox {vertical-align: middle;} /* ie6 */
*+html .tabbed-d  input.radio, *+html .tabbed-d input.checkbox {vertical-align: middle;} /* ie7 */
...
.tabbed-d input.text, .tabbed-d input.password, .tabbed-d textarea, .tabbed-d select {margin: 0; vertical-align: baseline;}
.tabbed-d input.text, .tabbed-d input.password, .tabbed-d textarea {border: 2px solid #CCC; padding: 4px; background:#FFF}

.tabbed-d form.horizontal .input-fake {padding: 4px; float:left;}
/*
input.disabled {
	opacity: 0.2;
	filter: alpha(opacity=20); 
...
.tabbed-d form.horizontal fieldset legend {display: inline; float: left; width: 140px; padding:4px;font-weight:bold; font-size:12px}
...
.jcrop-handle { font-size:1px; width:15px !important; height:16px !important; background:url('/images/handle.png') no-repeat top left; *width:9px; *height:9px }
.jcrop-tracker { width:100%; height:100% }
.custom .jcrop-vline, .custom .jcrop-hline { background:yellow }
.custom .jcrop-handle { border-color:black; background-color:#C7BB00; -moz-border-radius:3px; -webkit-border-radius:3px }
ul.menu-tab li.privacy { float: right;text-indent: -999999px; padding:0; }
ul.menu-tab li.privacy a { width: 16px; height: 14px; display:block;background: url('/images/lock.png');border:none;margin:8px;background-color:none}
.tabbed-d .content-tabs .alert-cuenta {background:#FFFFCC; border-top: 2px solid #e7e75a; border-bottom: 2px solid #e7e75a; padding: 15px; margin-bottom: 10px}
.tabbed-d .content-tabs .alert-cuenta h2 {margin:0}
...
.xtralarge .categoriaCom:hover, .xtralarge .categoriaUsuario:hover {
	background-color:#CCC;
	-moz-border-radius: 3px;
	-webkit-border-radius: 3px;
}
...
.action span.icon-noti, .notificaciones-list .icon-noti, .categoriaList span.icon-noti, .action span.icon-medallas, .notificaciones-list .icon-medallas, .categoriaList span.icon-medallas, div.group-4, div.group-6, div.group-3 {
	background-image: url('/images/sprite-notification.png');
	background-repeat: no-repeat;
	display:block;
	font-size:12px;
...
.notificaciones-list .icon-noti, .notificaciones-list .icon-medallas {
...
.action span.sprite-balloons ,.userInfoLogin  .sprite-balloons, .categoriaList .respuestas-n, .boxy-title .respuestas-n  { background-position: 0 -22px; } 
