...
$(document).ready(function() { 
     ...
     $('#psb').click(function() { $(window).unbind('beforeunload'); });
});
</script>
<div style="display: inline" id="preview">				
...
<div align="right"><input class="button" title="Cerrar previsualizaci&oacute;n" onclick="document.getElementById('preview').style.display='none';" value="Cerrar previsualizaci&oacute;n" type="button"> <input id="psb" class="button" title="Est&aacute; perfecto" onclick="document.getElementById('npf').submit();" value="Est&aacute; perfecto" type="button">&nbsp;&nbsp;</div><br></div>
